...
safe_dummy_tree_cpp <- function(pars, max_t, max_N, max_tries) {
    .Call('_emphasis_safe_dummy_tree_cpp', PACKAGE = 'emphasis', pars, max_t, max_N, max_tries)
}

safe_phylodiv_ctor_cpp <- function(pars, max_t, max_N) {
    .Call('_emphasis_safe_phylodiv_ctor_cpp', PACKAGE = 'emphasis', pars, max_t, max_N)
}

safe_phylodiv_sim_cpp <- function(pars, max_t, max_N) {
    .Call('_emphasis_safe_phylodiv_sim_cpp', PACKAGE = 'emphasis', pars, max_t, max_N)
}

safe_simulate_div_tree_cpp <- function(pars, max_t, max_N, max_tries) {
    .Call('_emphasis_safe_simulate_div_tree_cpp', PACKAGE = 'emphasis', pars, max_t, max_N, max_tries)
}
