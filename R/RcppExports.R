...
#'
#' @param brts Numeric vector of branching times (crown age first, sorted
#'   decreasing).
...
#' @param lower_bound Lower bounds for parameter optimisation.
...
#' @return A named list with trees, weights, fhat, logf, logg, and rejection
#'   counts.
#' @export
mc_loglik <- function(brts, pars, sample_size, maxN, soc, max_missing, max_lambda, lower_bound, upper_bound, xtol_rel, num_threads) {
    .Call('_emphasis_rcpp_mce', PACKAGE = 'emphasis', brts, pars, sample_size, maxN, soc, max_missing, max_lambda, lower_bound, upper_bound, xtol_rel, num_threads)
}
